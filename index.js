...
const farmAnimals2 = [moo, , baa, oink, cluck];
const farmAnimals3 = farmAnimals2;
const [bessie, ,dolly, babe, little] = farmAnimals3;

// 3. Little the chicken had to go back to the coop, so now we're left with three. Let's use color variables of blackAndWhite, black, and pink.

const farmAnimals4 = [moo, , baa, oink, ,];
const farmAnimals5 = farmAnimals4;
const [blackAndWhite, ,black, pink, ] = farmAnimals5;
...
const sixColors = [red, orange, yellow, green, blue, , violet];
